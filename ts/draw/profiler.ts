...
export class Profiler
{
    ...
    private state: State;
    private callback: ((result: ProfilerResult) => void) | null;
    private queryRunning: boolean;

    constructor(private ext: EXTDisjointTimerQuery | null, private logger: Logger)
    {
        this.queries = [];
        this.nextIndex = 0;
        this.activePhases = [];
    ...
    private checkMeasurementReady(): void
    {
        ...
        const resultPhases: ProfilerPhase[] = [];
